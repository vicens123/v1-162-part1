      ...
      <main className="flex-grow container mx-auto p-4 flex-col">
        <div className="flex-grow bg-white shadow overflow-hidden sm:rounded-lg my-4">
          <div className="p-4">
            ...
            <div className="p-3 my-3 rounded-lg text-gray-700 ml-auto bg-gray-100">
              ...
              <div className="text-xs">
                <hr className="border-b mt-5 mb-5 border-gray-200" />
                <div>
          ...
          <div className="p-4 bg-gray-100">
            ...
            ></textarea>
            <button className="mt-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">
              Send
            </button>
          </div>
        </div>
